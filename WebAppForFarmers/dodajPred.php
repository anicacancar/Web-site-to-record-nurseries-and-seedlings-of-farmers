    ...
    <body>
        ...
        <center>
            ...
            <table>
                ...
                <tr><td>Potvrdi lozinku: </td><td><input type = 'password' id='potvpass' name = 'potvpassword' size = '16' onchange = 'provjera();'></td></tr>
                ...
                <tr><td colspan='2'><center><input type = 'submit' class = 'button' name = 'potvrda' value = 'Dodaj preduzece'></center></td></tr>
                </table>
            </form>
            <div id='loz'>
            ...
            <a href = 'Admin.php' class='linkovi'>Vrati se na početnu stranu</a>
        </center>
        </div>
        <div id='footer'>
            COPYRIGHT
    ...
    {       
        ...
        if($_POST['skriveno'] == 'true')
        {
            if($_POST['password1'] == $_POST['potvpassword'])
            {
                ...
                $up = "SELECT ime FROM korisnik WHERE username = '".$_GET['us']."'";
                if($konekcija->getRed($up) == 0)
                {
                    ...
                    .$_POST['naziv']."','".$_POST['datumOsn']."','".$_POST['mjestoPred']."','".$_POST['mail']."','C', 1)";
                    $rezultat = mysqli_query($konekcija->getVeza(), $upit)
                                or die("Greska u upitu: ".$upit);
                    if($rezultat)
                    {
                        $u = "INSERT INTO kuriri(userPred,brojSlobodnihKurira) VALUES ('".$_POST['username']."',3)";
                        $r = mysqli_query($konekcija->getVeza(), $u)
                                         or die("Neuspjesan upit: ".$u);
                        echo "<script type='text/javascript'>ispisi('Uspjesno ste dodali korisnika!');</script>";
